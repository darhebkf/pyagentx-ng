...
- **[Manager Guide](/docs/manager)** — Query and monitor SNMP devices
- **[Manager Quickstart](/docs/manager/quickstart)** — Start polling devices
- **[Agent Guide](/docs/agent)** — Build SNMP agents that expose data
- **[Agent Quickstart](/docs/agent/quickstart)** — Jump straight to agent code
