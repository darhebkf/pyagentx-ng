...
pdm run python benchmarks/bench_ber.py

# GET requests
pdm run python benchmarks/bench_get.py

# WALK operations
pdm run python benchmarks/bench_walk.py
```

### Custom Target

```bash
SNMP_HOST=192.168.1.1 SNMP_COMMUNITY=private pdm run python benchmarks/bench_get.py
```
